...
if (isset($_POST['envoyer'])) {
    if (!empty($_POST['email']) && !empty($_POST['motdepasse'])) {
        ...
        // Assume que getadmin est une fonction qui vérifie les identifiants
        $admi = getadmin($email, $motdepasse);

        if ($admi) {
            // Création de session pour enregistrer les informations
            $_SESSION['SKDJNF?FFJIGNF?K'] = $admi;
            // Redirection
